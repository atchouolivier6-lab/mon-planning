...
function ajouterElement(jour, texte, barre) {
  let liste = document.getElementById("liste" + jour);
  let element = document.createElement("li");
  element.innerHTML = 
    "<span onclick='this.style.textDecoration=\"line-through\"' style='flex:1; cursor:pointer; text-decoration:" + barre + ";'>✅ " + texte + "</span>" +
...
function ajouterTache() {
  ...
  ajouterElement(jour, tache, "none");
  sauvegarder();
